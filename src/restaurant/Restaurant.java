...
public class Restaurant {
    ...
    public static void main(String[] args) {
        ...
        MenuItem item7 = new MenuItem("Chicken", "main", "a ten year old kid calls you a chicken", 7.99, false);
        Menu.addMenuItem(fancyMenu, item7);
        Menu.displayMenu(fancyMenu);

        Menu.removeMenuItem(fancyMenu, item6);
